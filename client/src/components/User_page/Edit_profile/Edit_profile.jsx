                    ...
                    <div className="max-w-sm mx-auto md:w-full md:mx-0">
                        <div className="inline-flex items-center space-x-4">
                            <a href="#" className="block relative">
                                <img alt="profil" src={useR.photoURL ? useR.photoURL : "https://xsurf.es/wp-content/uploads/2020/11/alternativas-tablas-surf-decathlon.jpg"} className="mx-auto object-cover rounded-full h-16 w-16 " />
                            </a>
                ...
                <div className="space-y-6 bg-white">
                    ...
                    <div className="items-center w-full p-8 space-y-4 text-gray-500 md:inline-flex md:space-y-0">
                        ...
                        <div className="text-center md:w-3/12 md:pl-6">
                            <button type="button" className="bg-green-400 text-white py-2 px-4 w-full tracking-wide rounded hover:bg-gray-600 focus:outline-none focus:bg-gray-600">
                                Change
                                    </button>
                        </div>
                    </div>
                    ...
                    <div className="w-full flex  px-4 pb-4 ml-auto text-gray-500 md:w-1/3">
                        ...
                        <Link to={`/userpage`} className="inline-flex">
...
export default Edit_Profile_User
